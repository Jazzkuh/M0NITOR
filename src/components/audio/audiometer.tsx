const AudioMeter = ({ text, left, right, balance, height = 508 }: { text: String, left: number, right: number, balance: number, height?: number }) => {
    ...
    function dbToY(db: number): number {
        ...
        return ((MAX_DB - clamped) / RANGE_DB) * METER_HEIGHT;
    }
        ...
        <div>
            ...
            <div>
                <input
                    ...
                    className="appearance-none disabled meter-range"
                    readOnly
                />
